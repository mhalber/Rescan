 ...
 */
 ...
 NK_API double               nk_glfw3_get_delta_time(void);
 ...
 nk_glfw3_render(enum nk_anti_aliasing AA, int max_vertex_buffer, int max_element_buffer)
 {
     ...
     glfw.delta_time = cur_time - glfw.prev_time;
     glfw.prev_time = cur_time;
 }
...
NK_API double
nk_glfw3_get_delta_time()
{
  return glfw.delta_time * 1000.0;
}
